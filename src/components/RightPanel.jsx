...
const RightPanel = ({ zoom, handleZoomIn, handleZoomOut, handleShowReportPopup }) => {
    return (
        <div id="video-controls" class="absolute top-2.5 right-2.5 flex flex-col gap-2.5">
            ...
            <button id="play-pause" class="w-[120px] opacity-50 bg-[rgba(0,0,0,0.5)] text-white border-0 p-2.5 cursor-pointer transition-opacity duration-300 z-[2] hover:opacity-100">Stopklatka</button>
